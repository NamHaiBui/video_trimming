...
# SQS Configuration
QUEUE_URL = os.getenv('SQS_QUEUE_URL', 'https://sqs.us-east-1.amazonaws.com/221082194281/test-video-trimming')
...
# root file
VIDEO_BUCKET = os.environ.get("VIDEO_BUCKET", "pd-video-storage-test")
#
